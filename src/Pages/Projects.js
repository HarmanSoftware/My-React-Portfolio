  ...
  return (
    <>
     ...
     <div className='grid lg:grid-cols-2 sm:grid-cols-1 gap-6 lg:h-96 sm:h-48'>
      ...
      <img className='h-96 scale-100 hover:scale-105 ease-in-out duration-500 rounded-lg drop-shadow-lg cursor-pointer'  src={HiMarketing}  alt="HiMarketing website img"/>
      </a>
     </div>
     </div>
